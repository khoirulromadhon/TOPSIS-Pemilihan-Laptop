									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_laptop=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($data_laptop['harga_angka'],$data_laptop['ram_angka'],$data_laptop['memory_angka'],$data_laptop['cpu_angka'],$data_laptop['inches_angka'] );
												?>
												<tr>
													...
													<td><center><?php echo $data_laptop['memory_angka'] ?></center></td>
													<td><center><?php echo $data_laptop['cpu_angka'] ?></center></td>
													<td><center><?php echo $data_laptop['inches_angka'] ?></center></td>
												</tr>
												<?php
												$no++;
											}
									...
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_laptop=mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no-1]=array($data_laptop['harga_angka']/$pembagiNM[0],
													$data_laptop['ram_angka']/$pembagiNM[1],
													$data_laptop['memory_angka']/$pembagiNM[2],
													$data_laptop['cpu_angka']/$pembagiNM[3],
													$data_laptop['inches_angka']/$pembagiNM[4]);

													?>
													<tr>
														<td><center><?php echo "A",$no ?></center></td>
														<td><center><?php echo round($data_laptop['harga_angka']/$pembagiNM[0],6)?></center></td>
														<td><center><?php echo round($data_laptop['ram_angka']/$pembagiNM[1],6) ?></center></td>
														<td><center><?php echo round($data_laptop['memory_angka']/$pembagiNM[2],6) ?></center></td>
														<td><center><?php echo round($data_laptop['cpu_angka']/$pembagiNM[3],6) ?></center></td>
														<td><center><?php echo round($data_laptop['inches_angka']/$pembagiNM[4],6) ?></center></td>
													</tr>
													<?php
													$no++;
												}
													...
													<tr>
														...
														for ($i=0; $i < count($nilaiV); $i++) { 
															if ($nilaiV[$i] == $testmax) {
																...
																<td><center><?php echo $user['produk']; ?></center></td>
																<?php
															}
														}
													} ?>
